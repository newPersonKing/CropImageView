...
@SuppressWarnings("unused") public class CropImageView extends ImageView {
  ...
  private void setupLayout(int viewW, int viewH) {
    ...
    Log.i("ccccccccc111c","mImageRect=="+mImageRect.width()+"==mImageRect=="+mImageRect.height());
  ...
  private float calcScale(int viewW, int viewH, float angle) {
    ...
    Log.i("ccccccccc","mImgWidth==="+mImgWidth+"=mImgHeight=="+mImgHeight);
  ...
  private Rect calcCropRect(int originalImageWidth, int originalImageHeight) {
    ...
    Log.i("cccccccccccc","originalImageWidth=="+originalImageWidth+"=originalImageHeight=="+originalImageHeight);
    Log.i("cccccccccccc","mImageRect=="+mImageRect.width()+"=mImageRect=="+mImageRect.height());
